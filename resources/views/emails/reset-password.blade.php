        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0"
          ...
          <tr>
            <td align="center"
              ...
              <!-- Logo image with glow (base64 embedded — no external URL needed) -->
          ...
          <tr>
            <td style="background:#111111;border-left:1px solid rgba(232,98,26,0.6);border-right:1px solid rgba(232,98,26,0.6);padding:0 48px 40px 48px;">
              ...
              <p style="margin:0 0 20px 0;font-size:16px;color:rgba(255,255,255,0.55);font-weight:normal;text-align:center;">
                Hello, <span style="color:#ffffff;font-weight:bold;">{{ ucwords($userName) }}</span>
              </p>
              ...
              <!-- Body text -->
              <p style="margin:0 0 8px 0;font-size:15px;line-height:1.75;color:rgba(255,255,255,0.60);text-align:center;">
                You are receiving this email because we received a password reset request for your account.
              </p>
              <p style="margin:0;font-size:14px;line-height:1.7;color:rgba(255,255,255,0.40);text-align:center;">
              ...
              <!-- Expiry notice -->
              <p style="margin:0 0 12px 0;font-size:13px;color:rgba(255,255,255,0.35);text-align:center;">
                This link will expire in <strong style="color:rgba(255,255,255,0.55);">{{ $count }} minutes</strong>.
              </p>

              <!-- Disclaimer -->
              <p style="margin:0;font-size:13px;color:rgba(255,255,255,0.30);text-align:center;line-height:1.6;">
          ...
          <tr>
            <td style="background:linear-gradient(180deg,#111111 0%,#0e0e0e 100%);border:1px solid rgba(232,98,26,0.6);border-top:1px solid rgba(255,255,255,0.08);border-radius:0 0 20px 20px;padding:28px 48px 32px 48px;">
              ...
              <p style="margin:0 0 8px 0;font-size:12px;color:rgba(255,255,255,0.28);line-height:1.6;">
                If you're having trouble clicking the "Reset Password" button, copy and paste the URL below into your web browser:
              </p>
              <p style="margin:0;font-size:12px;word-break:break-all;">
                <a href="{{ $actionUrl }}" style="color:#E8621A;text-decoration:none;opacity:0.80;">{{ $actionUrl }}</a>
              </p>
