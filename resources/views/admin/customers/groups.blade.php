<x-admin-layout title="{{ __('admin.groups_title') }}" section="customers" active="groups">
    ...
    <div class="card" style="text-align:center;padding:3rem 2rem;">
        ...
        <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap;">
            <span class="badge badge-gray">VIP / Wholesale Groups</span>
            <span class="badge badge-gray">Group-Based Pricing</span>
            <span class="badge badge-gray">Exclusive Discounts</span>
            <span class="badge badge-gray">Assign Customers</span>
        </div>
    </div>
