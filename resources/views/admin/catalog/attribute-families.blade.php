<x-admin-layout title="{{ __('admin.attr_families_title') }}" section="catalog" active="attr-families">
    ...
    <div class="info-banner">
        <span>🗃️</span>
        <div>
            <strong>Attribute Families</strong><br>
            Attribute Families group related attributes together (e.g. "Electronics" family includes Voltage, Wattage, Connectivity).
            Requires the Attributes module to be set up first.
        </div>
    </div>
    ...
    <div class="card" style="text-align:center;padding:3rem 2rem;">
        ...
        <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap;">
            <span class="badge badge-gray">Group Attributes</span>
            <span class="badge badge-gray">Assign to Products</span>
            <span class="badge badge-gray">Inherit &amp; Override</span>
        </div>
    </div>
